...
import math,time
from dataset.UDD import UnderwaterDataset
...
train_dataset=UnderwaterDataset("/home/cai/data/UDD/images/train",
                          '/home/cai/data/UDD/annotations/train.json',transform=transform)
...
# lr_schedule = [18700, 21000]
# lr_schedule = [37400, 42100]
# lr_schedule = [56200, 63200]
lr_schedule = [8760, 9860]
